...
WORLD = {
    ...
    TILE = {
        ...
        SOLID = { 17, 18, 50,
            ...
            16*24 + 6, 16*24 + 7, 16*24 + 8, 393,
            16*23 + 6, 16*23 + 7, 16*23 + 8, 16*23 + 9, 16*23 + 10, 16*23 + 11,

            -- table with carpet
            16*24, 16*24 + 1, 16*24 + 2,
            16*25 + 1, 16*25 + 2, 16*25 + 3,

            -- stone
            16*26 + 1, 16*26 + 2, 16*26 + 3,    16*26 + 5,
            16*27, 16*27 + 1, 16*27 + 2, 16*27 + 3, 16*27 + 4, 16*27 + 5,
            16*28 + 1, 16*28 + 2, 16*28 + 3,
        },
        WATER = { 32, 33, 34, 49,
            24, 25, 26, 27,
            104, 105, 106, 107,
